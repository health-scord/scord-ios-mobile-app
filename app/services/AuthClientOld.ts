                                    ...
                                    self.getUserData(null).then((res) => {
                                        ...
                                        self.createLocalAccount(
                                            ...
                                            () => {
                                                ...
                                                this.restClient.simpleFetch(
                                                    "https://us-central1-scord-260818.cloudfunctions.net/scord-score-calculation-daemon",
                                                    "GET",
                                                    {},
                                                    {},
                                                    {
                                                    ...
                                                    {
                                                        onComplete: (res) => {
                                                            console.log("success with call to trigger daemon", res);
                                                            
                                                        },
                                                        onError: (error) => {
                                                            console.log("error with call to trigger daemon", error);
